//Programa que faz imagens em preto e branco usando matrizes.
...
int main(){
	...
	int largura, altura, cor, i , j;
	char operacao[32], nome_arquivo[256];
	Ponto2D p1, p2, p3;
	Imagem * img;


	printf("Digite o nome do arquivo, a largura e altura respectivamente: ");
	scanf("%s %d %d", nome_arquivo, &largura, &altura);
	img = cria_imagem(altura, largura);
